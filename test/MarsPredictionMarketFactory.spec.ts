...
describe("Prediction Market Factory", async () => {
  ...
  it("Should create a category", async () => {
	  const tx = mars.predictionMarketFactory.updateCategory(
	  	ethers.utils.arrayify('0xb00b5428da0349e48763781ed54d7579'), 1, 'Crossing the frontier', 'Lorem ipsum')
  ...
  it("Should create a milestone", async () => {
	  ...
	  const tx2 = mars.predictionMarketFactory.updateMilestone(
		...
		1, 'First success of Spaceship Orbital Flight', 'Lorem ipsum', MilestoneStatus.Current)
