...
describe("Governance", async () => {
  ...
  it("Change outcome", async () => {
    ...
    // console.log("false", await gov.getOutcomeStatus(false, await users[1].getAddress()))
    console.log("true", (await gov.getOutcomeStatus(true, await users[1].getAddress()))[0].decision)
    console.log("true", (await gov.getOutcomeStatus(true, await users[1].getAddress()))[0].voted)
