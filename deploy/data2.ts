...
export const milestones = Array(
  ...
  Array("0x9823b01faeed4b139ea387920c16551e", "0xb00b5428da0349e48763781ed54d7579", "1", "Successful non-orbital test flight", "")
)
...
export const markets = Array(
  Array(
    ...
    "1",
    "Next non-orbital test flight of Starship takes place by July 2021",
    "",
    "1624633200", //in 8 hours
    "1624719600", //in a day
    "1000000",
    "1040000"
  ),
  Array(
    ...
    "1",
    "First orbital test flight of Starship takes place by December 2021",
    "",
    "1624590000", //4 hours ago
    "1624653200", //in 14 hours
    "1000000",
    "1200000"
  ),
  Array(
    ...
    "",
    "1624613200", //in 3 hours
    "1625238000", //in 7 days
    "1000000",
    "3360000"
  ),
  Array(
  ...
  Array(
    "0x132d38ff1bbf43d2a21383cc639f27fc",
    "1",
    "A Starship will return to Earth from a Mars trip by 2030",
    "",
    "1924991999",
    "1893455999",
    "1000000",
  ...
  Array(
    "0x521a30e96c1b40b08b3e98294e70a2f3",
    "1",
    "The first human will set foot on Mars by the year of 2035",
    "",
    "2082758399",
    "1924991999",
    "1000000",
...
export const outcomes = Array(
  Array(
    { uuid: "0xc53ef995914f4b409b22e6128c2bcf17", position: 1, name: "Yes" },
    { uuid: "0xc2c2c6cb226b42c4b36bf4b4dcb6ba17", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x6f471a5b81d04c5c82336577df545a01", position: 1, name: "Yes" },
    { uuid: "0x67626b863c99496dbce796d7c83415d6", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x63cf388c13914c9ea34e3947344a3a91", position: 1, name: "Yes" },
    { uuid: "0xc15005a06937422780754f8d498fc25f", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0xedf5058c59d34d5fa671b2035e4d9c1e", position: 1, name: "Yes" },
    { uuid: "0x8a6bc88956ec4cf2ab28dd6b9d9a21d0", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x25174325d51d4db6801a1630ab6f0f8d", position: 1, name: "Yes" },
    { uuid: "0x6ff4a1448cec42e1ba6acf2a10c83556", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0xbf9cb9177ed84ee8b6b144f4a4c9c27d", position: 1, name: "Yes" },
    { uuid: "0x5b9a045d776d45e89f321543c1a9a889", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x9484bbcd57484d6d9d871dff09acd73d", position: 1, name: "Yes" },
    { uuid: "0x516e10a64c924de080054d0b252c3c31", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x8e67a039bcbb4805ace5d704336de274", position: 1, name: "Yes" },
    { uuid: "0x7bd685df601d47d38ecc135b7f1b0915", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x8ded5a1b185040c6a7e745a64b91d8ad", position: 1, name: "Yes" },
    { uuid: "0x6e91d0a8239e4e68bf3a82bb450d6898", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x86ac0df9c34d469fac158ce6d9696ad8", position: 1, name: "Yes" },
    { uuid: "0x5e6d846b3ae246fe8a5c09d4b13f00fc", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x65971f65796749e4be49a707038e7784", position: 1, name: "Yes" },
    { uuid: "0x13390113b9e34e96bd3b6443513e5786", position: 1, name: "No" }
  ),
  Array(
    { uuid: "0x25971f65796749e4be49a707028e7784", position: 1, name: "Yes" },
    { uuid: "0x33310213b9e34e96bd3b6443513e5786", position: 1, name: "No" }
  )
)
